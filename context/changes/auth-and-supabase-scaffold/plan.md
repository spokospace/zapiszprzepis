...
- [x] 2.1 TypeScript się kompiluje: `npx tsc --noEmit`
- [x] 2.2 ESLint przechodzi: `npm run lint`
- [x] 2.3 `proxy.ts` istnieje na root projektu
- [x] 2.4 `src/lib/supabase/{server,client,proxy}.ts` istnieją
- [x] 2.5 `npm run build` przechodzi

#### Ręczne

- [x] 2.6 `npm run dev` → wejście na `/` przekierowuje na `/login` (307)
- [x] 2.7 Devtools Network potwierdza redirect 307 z `Location: /login`
- [x] 2.8 Próba wejścia na `/login` bez sesji nie powoduje pętli redirect
